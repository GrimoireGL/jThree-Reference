...
server.get('/api/class/global/:file_id/:factor_id', function(req, res) {
  ...
  return res.json(docs.getGlobalClassById(req.params.file_id, req.params.factor_id));
});
...
},{"./renderer/components/root-component":15,"./renderer/context":17,"./server/docs":22,"./server/initializeState":23,"express":undefined,"fs":undefined,"handlebars":undefined,"react":undefined}],2:[function(require,module,exports){
...
DocAction = (function(superClass) {
  ...
  DocAction.prototype.updateDoc = function(file_id, factor_id) {
    ...
    return new Promise((function(_this) {
      ...
      return function(res) {
        console.log(res);
        return _this.dispatch(keys.updateDoc, file_id, factor_id, res);
      };
...
},{"../keys":18,"bluebird":undefined,"material-flux":undefined,"superagent":undefined}],3:[function(require,module,exports){
...
},{"../keys":18,"html5-history":undefined,"material-flux":undefined}],4:[function(require,module,exports){
...
},{"./classdoc-component":6,"./error-component":8,"./header-component":9,"./index-component":10,"./link-component":11,"./route-component":16,"react":undefined}],5:[function(require,module,exports){
...
},{"./doc-container-component":7,"./list-component":12,"./route-component":16,"radium":undefined,"react":undefined}],7:[function(require,module,exports){
var DocContainerComponents, Link, React, Route,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
DocContainerComponents = (function(superClass) {
  ...
  DocContainerComponents.prototype.render = function() {
    var c, child, current, factor_id, file_id, group, id, ref, ref1;
    ...
    return React.createElement("div", null, ((function() {
      ...
      if ((file_id != null) && (factor_id != null)) {
        ...
        if (current != null) {
          return React.createElement("div", null, React.createElement("h1", null, current.name), React.createElement("div", null, ((function() {
            ...
            if (current.groups != null) {
              ...
              for (i = 0, len = ref3.length; i < len; i++) {
                ...
                results.push(React.createElement("div", {
                  "key": group.kind
                }, React.createElement("h2", null, group.title), React.createElement("div", null, (function() {
                  var j, k, len1, len2, ref4, ref5, results1;
                  ref4 = group.children;
                  results1 = [];
                  for (j = 0, len1 = ref4.length; j < len1; j++) {
                    ...
                    if (child != null) {
                      results1.push(React.createElement("div", {
                        "key": child.id
                      }, React.createElement("h3", null, child.name)));
                    } else {
                      results1.push(null);
                    }
                  }
...
},{"./link-component":11,"./route-component":16,"react":undefined}],8:[function(require,module,exports){
...
},{"./link-component":11,"./route-component":16,"radium":undefined,"react":undefined}],10:[function(require,module,exports){
...
ListComponent = (function(superClass) {
  ...
  ListComponent.prototype.constructNestedList = function(dir_tree) {
    var dir, file, folded, return_elm, top, tree;
        ...
        for (file in ref1) {
          ...
          return_elm.push((function(_this) {
            return function() {
              return React.createElement("li", {
                "key": file
              }, React.createElement(ListItemComponent, null, React.createElement(CharIconComponent, {
                "char": top.kindString[0],
                "style": [_this.genIconStyle(top.kindString), styles.icon]
              }), React.createElement(Link, {
                "href": "/class/" + (top.path.join('/')),
                "style": [styles.clickable, styles.link]
              }, top.name)));
            };
          })(this)());
        }
  ...
  ListComponent.prototype.genIconStyle = function(kindString) {
    var color, style;
    color = '#333333';
    switch (kindString) {
      case 'Class':
...
},{"./char-icon-component":5,"./link-component":11,"./list-folder-component":13,"./list-item-component":14,"radium":undefined,"react":undefined}],13:[function(require,module,exports){
...
ListFolderComponent = (function(superClass) {
  ...
  ListFolderComponent.prototype.render = function() {
    var return_elm;
    return React.createElement("div", null, (return_elm = [], React.Children.forEach(this.props.children, (function(_this) {
...
},{"./char-icon-component":5,"radium":undefined,"react":undefined}],14:[function(require,module,exports){
...
},{"./app-component":4,"react":undefined}],16:[function(require,module,exports){
...
},{"../lib/router":19,"radium":undefined,"react":undefined}],17:[function(require,module,exports){
...
},{"./actions/doc-action":2,"./actions/route-action":3,"./stores/doc-store":20,"./stores/route-store":21,"material-flux":undefined}],18:[function(require,module,exports){
module.exports = {
  route: 'route',
  updateDoc: 'updateDoc'
};
...
},{"object-assign":undefined}],20:[function(require,module,exports){
var DocStore, Flux, keys, objectAssign,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
DocStore = (function(superClass) {
  ...
  DocStore.prototype.updateDoc = function(file_id, factor_id, data) {
    var doc_data, name;
    doc_data = this.state.doc_data;
    doc_data[name = file_id.toString()] || (doc_data[name] = {});
...
},{"../keys":18,"material-flux":undefined,"object-assign":undefined}],21:[function(require,module,exports){
...
},{"../keys":18,"material-flux":undefined,"object-assign":undefined}],22:[function(require,module,exports){
...
},{"./stateInitializer/initializeStateConfig":25,"fs":undefined}],23:[function(require,module,exports){
  ...
  InitializeState.prototype.initialize = function(req) {
    ...
    this.router.route(req.originalUrl, (function(_this) {
      return function(route, argu) {
        ...
        if ((file_id != null) && (factor_id != null)) {
          initial_doc_data[file_id] || (initial_doc_data[file_id] = {});
          return initial_doc_data[file_id][factor_id] = _this.docs.getGlobalClassById(file_id, factor_id);
        }
      };
    })(this));
    initialState = {
...
},{"../renderer/lib/router":19,"./docs":22,"./stateInitializer/dir-tree":24,"./stateInitializer/initializeStateConfig":25,"./stateInitializer/routes-gen":26}],24:[function(require,module,exports){

/*
@providesModule DirTree
 */
var DirTree, _, objectAssign;
...
DirTree = (function() {
  ...
  constructDirTree = function(json) {
    ...
    json.children.forEach(function(child, i) {
      ...
      return dir_tree = _.merge({}, dir_tree, arrayToDirTree(arr, child));
    });
    return dir_tree;
  };
...
},{"lodash":undefined,"object-assign":undefined}],25:[function(require,module,exports){
var fs;
...
},{"fs":undefined}],26:[function(require,module,exports){
